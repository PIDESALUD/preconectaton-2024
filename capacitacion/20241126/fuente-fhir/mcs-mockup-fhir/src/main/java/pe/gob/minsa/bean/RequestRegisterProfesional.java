...
@AllArgsConstructor
@Data
public class RequestRegisterProfesional implements Serializable {

	private static final long serialVersionUID = 1L;	
	@NotEmpty(message = "El campo nombresProfesional es requerido")
	private List<@NotBlank(message = "El campo nombresProfesional es requerido") String> nombresProfesional;
	...
	@NotNull(message = "El campo nroCelularProfesional es requerido")
	@NotEmpty(message = "El campo nroCelularProfesional es requerido")
	@NotBlank(message = "El campo nroCelularProfesional es requerido")
	@Pattern(regexp = "^(\\d*)$", message= "El campo nroCelularProfesional no cumple con los estandares requeridos, es solo numeros")
	private String nroCelularProfesional;
